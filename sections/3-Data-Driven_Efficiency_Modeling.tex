...
The Random Forest model achieved the best performance, significantly outperforming the other models; therefore, it was selected to represent the converter efficiency and can be expressed as follows:
